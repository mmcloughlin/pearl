...
// PrivateEncrypt provides a mock function with given fields: _a0
func (_m *PrivateKey) PrivateEncrypt(_a0 []byte) ([]byte, error) {
	ret := _m.Called(_a0)
...
func (_m *PrivateKey) PublicDecrypt(_a0 []byte) ([]byte, error) {
	ret := _m.Called(_a0)
